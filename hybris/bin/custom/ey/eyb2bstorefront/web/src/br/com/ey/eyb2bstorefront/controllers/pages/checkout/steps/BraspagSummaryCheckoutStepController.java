...
import br.com.ey.eyb2bstorefront.form.PlaceOrderForm;
...
@Controller
@RequestMapping(value = "/checkout/multi/braspag/summary")
public class BraspagSummaryCheckoutStepController extends AbstractCheckoutStepController
{

	@Resource
	private EyCheckoutFacade eyCheckoutFacade;

	private static final Logger LOG = Logger.getLogger(BraspagSummaryCheckoutStepController.class);
