 ...
 */
package br.com.ey.core.constants;

/**
 * Global class for all EyCore constants. You can add global constants for your extension into this class.
 */
public final class EyCoreConstants extends GeneratedEyCoreConstants
{
	public static final String EXTENSIONNAME = "eycore";


	private EyCoreConstants()
	{
		//empty
	}
