...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/eystorefront/electronics/en",
						"https://electronics.local:9002/eystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/eystorefront/electronics/en",
						"https://electronics.local:9002/eystorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/eystorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/eystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/eystorefront/electronics/en",
						"https://electronics.local:9002/eystorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/eystorefront",
						"https://electronics.local:9002/eystorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/eystorefront",
						"https://electronics.local:9002/eystorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/eystorefront/electronics/en",
						"https://electronics.local:9002/eystorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
