...
import br.com.ey.test.constants.EyTestConstants;
import br.com.ey.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EyTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/eytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/eytest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/eytest/import/cstickets.impex");
			...
			importImpexFile(context, "/eytest/import/csquotes.impex");
		}
	}
}
